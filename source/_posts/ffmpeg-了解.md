...
ffmpeg 结构图
![ffmpeg 模块之间的结构](./Snip20180503_1.png)
...
1、ffprobe
![示例：查看一首歌的信息如下](./Snip20180503_2.png)
`
...
![示例：查看一个视频的信息如下](./Snip20180504_4.png)
`
matadata信息： 
...
![示例：用ffplay播放视频（对应的播放的率变换以及+ 视频界面）](./Snip20180504_6.png)
`
视频中s键会进入frame-step模式，s就会播放下一帧；观察某些视频内部的一些技巧，
`


![示例：用ffplay播放音频（对应的播放的率变换以及+ 语谱图画界面）](./Snip20180504_6.png)
![示例：用ffplay播放音频（对应的播放的率变换以及+ 语谱图画界面）](./Snip20180504_10.png)
`
